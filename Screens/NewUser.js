...
export default function NewUser(props) {
  ...
  return (
    <AuthContainer> {/* Use AuthContainer for layout and background */}
      <Text style={[fonts.title, { marginTop: 15, marginBottom: 10 }]}>Register</Text>
      <TextInput
      ...
      <TextInput
        ...
        secureTextEntry={true}
      />
      <View style={{ marginTop: 10, marginBottom: 20, flexDirection: "row", gap: 15 }}>
  <TouchableOpacity
